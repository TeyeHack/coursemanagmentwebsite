<%@ Page Title="" Language="C#" MasterPageFile="~/Adminp/Admin.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="GroupProject.Adminp.Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
         ...
         <div class="card">
                <div class="card-body">
                  <h4 class="card-title">CHANGE ADMIN PROFILE</h4>
