<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Teachers-Dashboard.Master" AutoEventWireup="true" CodeBehind="Add-Students.aspx.cs" Inherits="GroupProject.Teacher.Add_Students" %>
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
         ...
         <label><i class="fa fa-venus"></i> Gender</label>
            ...
            <asp:DropDownList ID="drplevl" Cssclass="form-control mt-2" type="text"  runat="server">
                 ...
                 <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Course</label>
                        <asp:DropDownList ID="drpCours" Cssclass="form-control mt-2" type="text"  runat="server">
                                                <asp:ListItem>Select Course</asp:ListItem>
                                                <asp:ListItem>Ethics and Security</asp:ListItem>
          ...
          <asp:TextBox ID="txtPass" Type="password" Cssclass="form-control mt-2" placeholder="Enter Password"   runat="server"></asp:TextBox>
                           ...
                           <asp:Button ID="Button1" runat="server"  class="btn btn-primary me-2" Text="Submit" OnClick="btnsubmit_Click" />
                            <asp:Button ID="Button2" runat="server"  class="btn btn-primary me-2" Text="Update" OnClick="btnupdt_Click"  />
                             <asp:Button ID="Button3" runat="server"  class="btn btn-primary me-2" Text="Delete" OnClick="btndel_Click"/>
         ...
         <div class="card">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="form-outline m-2">
                            ...
                            <asp:TextBox ID="Txtsearchk"  text="Search with Student ID." Cssclass="form-control" Style="width:25rem;" runat="server"></asp:TextBox>
                              <asp:Button ID="btnsearch" runat="server"  class="btn btn-primary mt-1" Text="Search" OnClick="btnsearh_Click"  />
          ...
          <Columns>
                 <asp:BoundField DataField="Name" ItemStyle-CssClass=""  HeaderText="Name"/>
                    <asp:BoundField DataField="IDNumber" ItemStyle-CssClass="" HeaderText="IDNumber"/>
                    <asp:BoundField DataField="Gender" ItemStyle-CssClass="" HeaderText="Gender"/>
                    <asp:BoundField DataField="Level" ItemStyle-CssClass=""  HeaderText="Level"/>
               <asp:BoundField DataField="Course" ItemStyle-CssClass="" HeaderText="Course"/>
