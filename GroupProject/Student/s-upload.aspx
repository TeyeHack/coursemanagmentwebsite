<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMD.Master" AutoEventWireup="true" CodeBehind="s-upload.aspx.cs" Inherits="GroupProject.Student.s_upload" %>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">UPLOAD ASSIGNMENT</h4>
                     ...
                     <asp:Label ID="lblmsg" runat="server" Cssclass="card-description alert alert-danger form-control"  Text="Enter alls Fields"></asp:Label>     
                       <asp:Label ID="Label1" runat="server" Cssclass="alert alert-danger form-control mt-2"  Text="Enter alls Fields" Visible="False"></asp:Label>     
             ...
             <asp:Button ID="Button1" runat="server"  class="btn btn-primary me-2" Text="Submit" OnClick="btnsubmit"/>
              ...
              <asp:Button ID="Button3" runat="server"  class="btn btn-danger me-2" Text="UnSubmit" OnClick="btndelete"/>
         ...
         <div class="card">
                  ...
                  <h4 class="card-title">ASSIGNMENT</h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="form-outline m-2">
                              ...
                              <asp:TextBox ID="Txtsearchk" type="search" text="Search here" Cssclass="form-control" Style="width:25rem;" runat="server"></asp:TextBox>
                              <asp:Button ID="Button4" runat="server"  class="btn btn-primary mt-1" Text="Search" OnClick="Button4_Click" />
          ...
          <Columns>
                    ...
                    <asp:BoundField DataField="AssignmentID" ItemStyle-CssClass=""  HeaderText="Assignment Name"/>
                             <asp:BoundField DataField="SubmissionDate" ItemStyle-CssClass=""  HeaderText="Date Of Submission"/>
