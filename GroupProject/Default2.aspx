<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default2.aspx.cs" Inherits="GroupProject.Default2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin:0 auto; width:1000px;" class="card shadow-1-strong">
            <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    <table style="width: 100%;">
                            ...
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="float: right; background-color: yellow; color: black;"><b><span id="lbresult" runat="server">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="grdquestions" runat="server" AutoGenerateColumns="false" OnRowDataBound="grdquestions_RowDataBound" DataKeyNames="QuestionId" Width="100%" CssClass="table card-body">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Answer all questions">
                                            <ItemTemplate>
                        ...
                        <tr>
                            <td> 
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-primary" OnClientClick="return CheckIfAllQuestionAnswerHasBeenSubmitted()" OnClick="btnsubmit1" />
            ...
            <script >
                ...
                function CheckIfAllQuestionAnswerHasBeenSubmitted() {
                    ...
                    if (parseInt(flagtocheckcount) == parseInt(numItems)) {
                        ...
                        $("#lbresult").text("Final Result-:" + CountFinalResult + "/3");//Count Quetions
                        $("#lbresult1").text("" + CountFinalResult + "/3");//Count Quetions
